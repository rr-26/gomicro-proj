...
build_broker:
	...
	chdir ..\gomicro-backend && set GOOS=linux&& set GOARCH=amd64&& set CGO_ENABLED=0 && go build -o ${BROKER_BINARY} ./cmd/api
	@echo Done!
...
start: build_front
	...
	chdir ..\gomicro-frontend && start /B ${FRONT_END_BINARY} &
